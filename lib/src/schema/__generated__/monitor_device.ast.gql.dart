...
const MonitorDevice = _i1.OperationDefinitionNode(
  ...
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'range')),
      type: _i1.NamedTypeNode(
    ...
    _i1.FieldNode(
      ...
      arguments: [
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'range')),
        ),
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
...
const document = _i1.DocumentNode(definitions: [MonitorDevice]);
